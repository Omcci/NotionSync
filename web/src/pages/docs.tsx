  ...
  const features = [
    {
      ...
      description:
        'Seamlessly connect your GitHub repositories with one-click OAuth authentication',
    },
    {
      icon: <Database className="w-6 h-6" />,
      title: 'Notion Sync',
      description:
        'Automatically sync repository data, commits, and issues to your Notion workspace',
    },
    {
    ...
    },
    {
      ...
      description:
        'Your data is encrypted and we only access what you explicitly allow',
    },
    {
  ...
  const steps = [
    {
      ...
      description:
        'Authenticate with GitHub and select which organizations and repositories you want to sync',
    ...
    },
    {
      ...
      description:
        'Choose what data to sync: commits, issues, pull requests, and more',
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 p-6 rounded-lg border">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              NotionSync is a powerful integration platform that bridges the gap
              between your GitHub repositories and Notion workspace. It
              automatically synchronizes your development data, making project
              management and documentation effortless.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-lg">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Repositories, commits, issues, PRs
                </p>
              </div>
              <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-lg">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-8">
              Discover how to seamlessly integrate your GitHub repositories with
              Notion, automate your workflow, and boost your team&apos;s
              productivity.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Everything you need to connect your development workflow with your
              documentation
            </p>
          </div>
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Explore the platform features and see how everything works
              together
            </p>
          </div>
