  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24 bg-gray-50 dark:bg-gray-900">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center mt-12">
        <Card>
          <Image src="/neural.jpg" alt="Workflow Image" width={400} height={200} className="rounded-t-lg" />
          <CardHeader>
        ...
        <Card>
          ...
          <Image src="/collab.jpg" alt="Collaboration Image" width={400} height={200} className="rounded-b-lg" />

        </Card>
        <Card>
          <Image src="/gh.webp" alt="Repository Image" width={400} height={200} className="rounded-t-lg" />
          <CardHeader>
