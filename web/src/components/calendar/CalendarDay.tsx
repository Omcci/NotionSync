...
export interface CalendarDayProps {
    ...
    renderDay?: (date: Date, events: CalendarEvent[], isCurrentMonth: boolean, isToday: boolean) => React.ReactNode
    eventClassName?: string | ((event: CalendarEvent) => string)
    dayClassName?: string | ((date: Date, isCurrentMonth: boolean, isToday: boolean) => string)
...
export function CalendarDay({
    ...
    const computedDayClassName = typeof dayClassName === 'function'
