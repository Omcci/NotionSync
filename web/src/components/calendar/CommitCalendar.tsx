...
export function CommitCalendar({
  ...
  const renderDay = (
    ...
    return (
      <div
        data-date={format(date, 'yyyy-MM-dd')}
        className={`calendar-day-cell relative transition-all duration-200 cursor-pointer border-r border-b border-gray-200 dark:border-gray-700 last:border-r-0 ${
          isCurrentMonth
