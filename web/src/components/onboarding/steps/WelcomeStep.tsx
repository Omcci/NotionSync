        ...
        <div className="text-center space-y-6">
            ...
            <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">
                    We&apos;ll help you connect your GitHub repositories with Notion in just a few simple steps.
                </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
                <div className="flex flex-col items-center p-4 border rounded-lg">
                    ...
                    <p className="text-sm text-gray-500 text-center">Choose which repositories to sync</p>
                </div>
                <div className="flex flex-col items-center p-4 border rounded-lg">
                    <Settings className="w-8 h-8 text-green-600 mb-2" />
                    <h3 className="font-semibold">Configure</h3>
                    <p className="text-sm text-gray-500 text-center">Set up your sync preferences</p>
                </div>
                <div className="flex flex-col items-center p-4 border rounded-lg">
                    <Zap className="w-8 h-8 text-purple-600 mb-2" />
                    <h3 className="font-semibold">Start Syncing</h3>
                    <p className="text-sm text-gray-500 text-center">Begin automatic synchronization</p>
                </div>
            </div>
        </div>
    )
