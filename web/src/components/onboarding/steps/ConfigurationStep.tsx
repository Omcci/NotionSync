        ...
        <div className="space-y-6">
            <div className="text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                    Set up your default sync preferences. You can customize these for each repository later.
                </p>
            </div>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="space-y-2">
                            <div className="flex items-center space-x-2">
                                <input type="radio" id="manual" name="sync-frequency" defaultChecked />
                                <label htmlFor="manual" className="text-sm font-medium">Manual sync only</label>
                            </div>
                            <div className="flex items-center space-x-2">
                                <input type="radio" id="hourly" name="sync-frequency" />
                                <label htmlFor="hourly" className="text-sm font-medium">Every hour</label>
                            </div>
                            <div className="flex items-center space-x-2">
