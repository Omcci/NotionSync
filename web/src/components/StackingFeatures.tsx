...
const FeatureItem = ({ title, description, number, index, imageSource, link, button, gradient, icon }: FeatureItemProps) => {
    return (
        <div
                ...
                <div className="flex-1 flex flex-col justify-center pr-0 lg:pr-8">
                    <div>
                        <div className="flex items-center mb-6">
                            <div className={`inline-flex p-4 rounded-2xl bg-gradient-to-r ${gradient} text-white mr-4`}>
                                {icon}
                            </div>
...
const StackingFeatures = forwardRef((_props, ref: ForwardedRef<HTMLElement>) => {
    ...
    const features = [
        {
            ...
            description: "Automatically sync your GitHub activity to Notion. Every commit, branch, and collaboration update flows seamlessly into your workspace without any manual intervention.",
        ...
        },
        {
            ...
            description: "Track your development progress with intelligent calendar views that automatically organize your commits, pull requests, and project milestones for maximum visibility.",
        ...
        },
        {
            ...
            description: "Keep your entire team synchronized with real-time updates, shared insights, and collaborative project management tools that enhance productivity.",
