  ...
  const handleReauthorize = async () => {
    try {
      ...
      toast({
        ...
        description:
          'You will be redirected to GitHub to update your permissions',
      })
    } catch (error) {
      toast({
        title: 'Error',
          ...
          <Dialog open={showReauthDialog} onOpenChange={setShowReauthDialog}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  To change your organization permissions or add access to new
                  organizations, you need to re-authorize with GitHub.
                </DialogDescription>
              </DialogHeader>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-yellow-700 dark:text-yellow-300 mt-1">
                        Re-authorization will temporarily sign you out and
                        redirect you to GitHub where you can update your
        ...
        <CardContent>
          {isLoading ? (
            ...
            <div className="text-center py-8 text-gray-500">
              ...
              <p className="text-sm">
                You may need to request access from organization owners or
                re-authorize
              </p>
              <Button
                variant="outline"
                          ...
                          <div className="flex items-center space-x-2 mt-1">
                            ...
                            <span className="text-xs text-gray-500">
                              ...
                              {org.total_private_repos &&
                                ` • ${org.total_private_repos} private repos`}
                            </span>
                          </div>
                        </div>
                      </div>
        ...
        <CardContent className="space-y-3">
          <div className="text-sm text-gray-600 dark:text-gray-300">
            ...
            <ul className="space-y-1 list-disc list-inside">
              <li>
                <strong>Missing organizations:</strong> You may need to request
                access from organization owners
              </li>
              <li>
                <strong>Limited permissions:</strong> Contact your organization
                admin to upgrade your role
              </li>
              <li>
                <strong>Can&apos;t see private repos:</strong> Re-authorize to
