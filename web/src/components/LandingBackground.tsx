...
const LandingBackground: React.FC = () => {
  ...
  return (
    <div className={`fixed inset-0 w-full h-full overflow-hidden z-[-10] ${isDarkMode ? 'bg-black' : 'bg-white'}`}>
      <svg
      ...
      >
          ...
          <linearGradient id="grad1" x1="0%" y1="0%" x2="100%" y2="100%">
            {isDarkMode ? (
              <>
                ...
                <stop offset="100%" style={{ stopColor: '#504f4f', stopOpacity: 1 }} />
              </>
            ) : (
              <>
        ...
        <g filter="url(#glow)">
          <path d="M0 600 Q 480 750 960 600 Q 1440 450 1920 600" fill="none" stroke={isDarkMode ? "#4a5568" : "#dedede"} strokeWidth="2" opacity="0.3">
          ...
          <path d="M0 700 Q 480 550 960 700 Q 1440 850 1920 700" fill="none" stroke={isDarkMode ? "#718096" : "#648fd4"} strokeWidth="2" opacity="0.5">
            <animate attributeName="d"
          ...
          <path d="M0 800 Q 480 950 960 800 Q 1440 650 1920 800" fill="none" stroke={isDarkMode ? "#a0aec0" : "#8babbc"} strokeWidth="2" opacity="0.7">
            <animate attributeName="d"
