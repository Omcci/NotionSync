...
const calendarTips = [
  {
    ...
    description:
      'Click on any date to see all commits made that day across your repositories.',
  },
  {
    icon: <Target className="w-6 h-6 text-green-500" />,
    title: 'Filter by Repository',
    description:
      'Use the repository selector to focus on specific projects and see their commit patterns.',
  },
  {
    icon: <Clock className="w-6 h-6 text-purple-500" />,
    title: 'Track Your Productivity',
    description:
      'Visualize your coding streaks and identify your most productive days and times.',
  },
  {
    icon: <Users className="w-6 h-6 text-orange-500" />,
    title: 'Export & Share',
    description:
      'Generate reports of your development activity to share with your team or manager.',
  },
]
