const LandingBackgroundDark: React.FC = () => {
  return (
    <div className="fixed inset-0 w-full h-full bg-black overflow-hidden z-[-10]">
      ...
      >
        ...
        <g filter="url(#glow)">
          <path d="M0 600 Q 480 750 960 600 Q 1440 450 1920 600" fill="none" stroke="#4a5568" strokeWidth="2" opacity="0.3">
          ...
          <path d="M0 700 Q 480 550 960 700 Q 1440 850 1920 700" fill="none" stroke="#718096" strokeWidth="2" opacity="0.5">
            <animate attributeName="d"
          ...
          <path d="M0 800 Q 480 950 960 800 Q 1440 650 1920 800" fill="none" stroke="#a0aec0" strokeWidth="2" opacity="0.7">
            <animate attributeName="d"
...
export default LandingBackgroundDark;
