        ...
        <div className="max-w-4xl mx-auto space-y-6">
            <div className="text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300 text-lg">
                    Let&apos;s set up your GitHub integration to start syncing your repositories with Notion
                </p>
            </div>
                    ...
                    <div className="space-y-3">
                        <div className="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600 dark:text-gray-400">
                                    Read access to your repositories, commits, and branches for syncing with Notion
                                </p>
                            </div>
                        </div>
                        <div className="flex items-start space-x-3">
                ...
                <CardContent className="space-y-4">
                        ...
                        <div className="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-blue-700 dark:text-blue-300 mt-1">
                                    When you click &quot;Connect GitHub Account&quot; below, you&apos;ll be redirected to GitHub&apos;s authorization page.
                                    There, GitHub will show you a list of organizations you belong to and you can choose which ones to grant NotionSync access to.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="space-y-2 text-sm">
                            ...
                            <div className="flex items-center space-x-2">
                                <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                                <span>Checkboxes to grant or deny access to each organization</span>
                            </div>
                            <div className="flex items-center space-x-2">
                                <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                        ...
                        <div className="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-yellow-700 dark:text-yellow-300 mt-1">
                                    Don&apos;t worry! You can always update your organization permissions later
                                    through the &quot;GitHub Access&quot; tab in Settings.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <CardContent className="space-y-3">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                            <h4 className="font-medium text-green-700 dark:text-green-300">✓ We DO</h4>
                        ...
                        <div className="space-y-2">
                            <h4 className="font-medium text-red-700 dark:text-red-300">✗ We DON&apos;T</h4>
                            <ul className="text-sm space-y-1 text-gray-600 dark:text-gray-400">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Dialog open={showConfirmDialog} onOpenChange={setShowConfirmDialog}>
                    ...
                    <DialogContent>
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                You&apos;ll be redirected to GitHub&apos;s secure authorization page where you can:
                            </DialogDescription>
                        </DialogHeader>
                        <div className="space-y-4">
                            <div className="space-y-2">
                                <div className="flex items-center space-x-2">
                                    ...
                                    <span className="text-sm">Review the permissions NotionSync is requesting</span>
                                </div>
                                <div className="flex items-center space-x-2">
                                    <CheckCircle className="w-4 h-4 text-green-600" />
                                    <span className="text-sm">Choose which organizations to grant access to</span>
                                </div>
                                <div className="flex items-center space-x-2">
                                    <CheckCircle className="w-4 h-4 text-green-600" />
                                    <span className="text-sm">Authorize the connection securely</span>
                                </div>
                            </div>
                            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3">
                                <p className="text-sm text-blue-700 dark:text-blue-300">
                                    <strong>Remember:</strong> You can always modify your organization permissions later in Settings → GitHub Access.
                                </p>
                            </div>
                ...
                <Button
                    variant="outline"
                    size="lg"
                    onClick={() => window.open('https://docs.github.com/en/developers/apps/managing-oauth-apps/authorizing-oauth-apps', '_blank')}
