...
export class GitHubService {
    ...
    static async getUserRepos(token: string, page = 1, perPage = 30): Promise<GitHubRepo[]> {
        try {
    ...
    static async getRepository(token: string, owner: string, repo: string): Promise<GitHubRepo> {
        try {
