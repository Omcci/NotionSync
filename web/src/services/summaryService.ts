...
export class SummaryService {
    ...
    static async getSummariesForDateRange(
        ...
        try {
            ...
            return { summaries: [], error: error instanceof Error ? error.message : 'Unknown error' }
        }
    }
    ...
    static async generateAndStoreSummary(
        ...
        try {
            ...
            const existingSummary = await this.getSummary(request.userId, request.date, request.repoId)
